...
import 'package:aplikasi_pi/screens/informasi/components/sosmed_ig.dart';
import 'package:aplikasi_pi/screens/informasi/components/sosmed_wa.dart';
      ...
      children: [
        Container(
          child: PageView(
            ...
            children: [CaraOrder(), WhatsappPage(), InstagramPage()],
          ),
        ),
        Padding(
          ...
          child: Align(
            ...
            child: Obx(() => Row(
              children: [
                ...
                Spacer(flex: 3),
                controller.halaman.value == 3 ? SizedBox() :
                FloatingActionButton(
                    heroTag: "maju",
                    onPressed: () {
